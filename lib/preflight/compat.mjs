...
// Throws SCHEMA_INCOMPATIBLE on violation. Message MUST include code.
...
/**
 * @param {{ endpoints: object, matrix: Record<string, {min:string}>|Record<string,string> }} param0
...
export function verifyCompat({ endpoints, matrix }) {
  ...
  for (const svc of services) {
    ...
    if (schema !== 'mcp.v1') {
      throw makeErr('SCHEMA_INCOMPATIBLE', `Unknown schema_version ${schema}`, {
