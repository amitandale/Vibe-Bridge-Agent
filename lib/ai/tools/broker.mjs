...
export function createToolBroker({ projectRoot = process.cwd(), root = undefined, prefer='node', timeoutMs=60000, maxReadBytes=512*1024 } = {}) {
  // Accept both {projectRoot} and legacy {root}
  projectRoot = projectRoot || root || process.cwd();
