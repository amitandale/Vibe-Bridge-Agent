...
// ------------ robust glob → regex ------------
// Supports: ** (globstar), double-star with slash (directory glob), * (segment), ? (single char).
// Note: using line comments to avoid "*/" terminator sequence inside block comments.
