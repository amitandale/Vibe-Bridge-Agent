...
export function _checksum(content){ return createHash('sha256').update(content,'utf8').digest('hex'); }
...
// BA-02 compat: named export expected by tests
export function migrate() { ensureMigrationsTable(); return applyAll(); }
